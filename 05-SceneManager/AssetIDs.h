...
#define ID_SPRITE_KOOPAS_SHELL_SLIP_LEFT	(ID_SPRITE_KOOPAS_SHELL + 300)
#define ID_SPIRTE_KOOPAS_SHELL_SLIP_RIGHT	(ID_SPRITE_KOOPAS_SHELL + 400)
...
#define ID_SPRITE_KOOPASFLY_SHELL_SLIP_LEFT (ID_SPRITE_KOOPASFLY_SHELL + 300)
#define ID_SPRITE_KOOPASFLY_SHELL_SLIP_RIGHT (ID_SPRITE_KOOPASFLY_SHELL + 400)