...
#define RANGE_BETWEEN_OBJECT	3

#define MARIO_ACCEL_WALK_X	0.0005f
#define MARIO_ACCEL_RUN_X	0.0007f

#define MARIO_ACCEL_SLOWING_DOWN_X_PARAM 12
...
#define MARIO_SPEED_SWITCH_SCENE	0.02f
...
#define ID_ANI_MARIO_HOLD_RIGHT	1004
#define ID_ANI_MARIO_HOLD_LEFT	1005

#define ID_ANI_MARIO_HOLD_KOOPAS_RIGHT	1006
#define ID_ANI_MARIO_HOLD_KOOPAS_LEFT	1007

#define ID_ANI_MARIO_PIPE	1008

#define ID_ANI_MARIO_JUMPING_HOLD_KOOPAS_RIGHT	1009
#define ID_ANI_MARIO_JUPMING_HOLD_KOOPAS_LEFT	1010
...
class CMario : public CGameObject
{
	...
	void OnCollisionWithEndGameItem(LPCOLLISIONEVENT e);
...
public:
	...
	CMario(float x, float y) : CGameObject(x, y)
	{
		...
		coin = 0;
		type = 0;
		timeStack = timeAttacking = timeFlying = timeFalling = timeEnd = timeKick = timeSwitch = ULONGLONG(0);
		powerStack = 0;
		tail = NULL;
